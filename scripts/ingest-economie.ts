...
const BDM_SERIES: BdmSeriesConfig[] = [
  ...
  // ─── New series: Salaires ───
  {
    ...
    description: "Indice du SMIC horaire brut (base 100 = valeur de reference)",
    domaine: "salaires",
    unite: "indice",
    frequence: "annuel",
    lastNObs: 40,
  ...
  // ─── New series: Finances publiques / Dette ───
  {
    ...
    idBanks: "001694258",
    nom: "Dette publique",
    description: "Dette des administrations publiques au sens de Maastricht, en centaines de millions d'euros",
    domaine: "finances",
    unite: "centaines_millions_eur",
    frequence: "annuel",
    lastNObs: 40,
  },
  {
  ...
  },
  {
    ...
    idBanks: "001710399",
    nom: "Dépenses publiques",
    description: "Dépenses des administrations publiques (unité BDM)",
    domaine: "finances",
    unite: "nombre",
    frequence: "annuel",
    lastNObs: 40,
