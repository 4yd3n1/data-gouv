...
export const FISCAL_GIFTS: SourcedFact[] = [
  {
    text: "Suppression de l'ISF : perte de recettes fiscales cumulée",
    value: "~35 Md EUR",
    source: "Vie-publique / France Stratégie",
  },
  {
    text: "Flat tax (PFU 30 %) : 1 % des ménages détiennent 96 % des dividendes",
    value: "Zéro effet mesurable sur l'investissement",
    source: "France Stratégie, rapport final 2023",
  },
  {
    text: "CICE : coût total pour ~100 000 emplois créés",
    value: "~110 Md EUR (~900 000 EUR/emploi)",
    source: "France Stratégie",
  },
  {
    text: "TotalÉnergies : impôt sur les sociétés payé en France (2020 et 2021)",
    value: "0 EUR",
    source: "Rapports annuels / Le Monde",
  },
  {
    text: "Taxe sur les super-profits : rendement réel vs attendu",
    value: "69 M EUR vs 3-6 Md EUR attendus",
