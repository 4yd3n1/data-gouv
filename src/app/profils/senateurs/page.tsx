...
async function SenateursList({ searchParams }: { searchParams: Record<string, string> }) {
  ...
  return (
    <>
      ...
      <Pagination currentPage={page} totalPages={Math.ceil(total / PER_PAGE)} baseUrl="/profils/senateurs" searchParams={searchParams} />
    </>
  );
}
  ...
  return (
    <>
      <PageHeader
        ...
        breadcrumbs={[{ label: "Accueil", href: "/" }, { label: "Profils", href: "/profils" }, { label: "Sénateurs" }]}
      />
