    ...
    <>
      ...
      <div className="grid gap-2">
        {lobbyistes.map((l) => (
          <Link
            key={l.id}
            href={`/representants/lobbyistes/${l.id}`}
      ...
      <Pagination currentPage={page} totalPages={Math.ceil(total / PER_PAGE)} baseUrl="/representants/lobbyistes" searchParams={searchParams} />
    </>
  );
}
